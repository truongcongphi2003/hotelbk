...
export const erp = {
  ...
  get:
    ...
    async (dispatch) => {
      ...
      let data = await request.get({ entity, id });
      if (data.success === true) {
        dispatch({
          type: actionTypes.CURRENT_ITEM,
          keyState: 'get',
  ...
  updateAndUpload:
    ...
    async (dispatch) => {
      ...
      let data = await request.updateAndUpload({ entity, id, fieldsValue });
  ...
  updateTypePost:
    ...
    async (dispatch) => {
      ...
      let data = await request.post({ entity, id, jsonData });
